...
!!! quote "Zybooks"  
    ...
    **expression:** 
    ...
    - A common place where expressions are used is on the right side of an [assignment statement](2.1-variable-assignments.md), as in y = 2 * (x + 1).  
...
|* / %|Next to be evaluated are *, /, and %, having equal precedence.|(% is [discussed elsewhere](2.7-division-modulo.md).)|  
...
- [Python Expressions](2.6-python-expressions.md)  
- [Division & Modulo](2.7-division-modulo.md)  