# String Basics
**string:**
A string is a [sequence of characters](../ch02/2.11-representing-text.md), like the text MARY, that can be stored in a variable.  
...
Strings are [immutable](3.3-tuple-basics.md) and cannot be changed  
```
...
- [List Basics](3.2-list-basics.md)  
- [String Formatting](3.10-string-formatting.md)  
