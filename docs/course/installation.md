...
!!! tip "Anaconda Slides"
    ...
    Ctrl + Click to open the deck in a new tab, then press <kbd>F</kbd> for fullscreen.  

[Anaconda Installation Slides](../assets/slides/installation.html){ target="_blank" }  