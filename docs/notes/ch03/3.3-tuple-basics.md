# 3.3 Tuple Basics
**tuple:**
A tuple, usually pronounced "tuhple" or "toople," stores a collection of data, like a [list](3.2-list-basics.md), but is [immutable](3.1-string-basics.md) – once created, the tuple's elements cannot be changed.  
