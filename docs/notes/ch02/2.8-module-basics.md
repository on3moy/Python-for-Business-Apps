...
**Dot Notation**
Once a module is imported, any [object](2.3-objects.md) defined in that module can be accessed using dot notation.  
...
- [Math Module](2.9-math-module.md)  
- [Random Numbers](2.10-random-numbers.md)  