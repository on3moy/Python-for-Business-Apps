# 3.2 List Basics
**container**:
A [container](3.4-dictionary-basics.md) is a construct used to group related values together and contains references to other objects instead of data.  
...
!!! example "method example"
    ...
    For our [strings](3.1-string-basics.md) example, python allows us to perform actions, like a split.  
...
You can also do many neat things to lists. [Similar to a column in excel](3.3-tuple-basics.md).  
...
- [String Basics](3.1-string-basics.md)  
- [Tuple Basics](3.3-tuple-basics.md)  
- [Dictionary Basics](3.4-dictionary-basics.md)  
- [Representing Text](../ch02/2.11-representing-text.md)  