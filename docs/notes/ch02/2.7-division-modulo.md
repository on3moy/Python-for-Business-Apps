# 2.7 Division & Modulo  
## Division  
Division returns a [float](2.4-numeric-types.md). Even if you divide two integers and there isn't a remainder, you still get a float returned.  
Input:
`4 / 2`  
Output:
`2.0`
...
- [Numeric Types](2.4-numeric-types.md)  
- [Arithmetic Expressions](2.5-arithmetic-expressions.md)  