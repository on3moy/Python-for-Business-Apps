...
!!! quote "Zybooks"  
    ...
    **identifier / name / underscores:**
    An identifier, also called a [name](2.1-variable-assignments.md), is a sequence of letters (a-z, A-Z), underscores (_), and digits (0–9), and must start with a letter or an underscore.  
...
??? question "How can we know which words not to use?"
    ...
    - We can discuss what it all does [a little later](2.8-module-basics.md).  
...
- [Variables and assignments](2.1-variable-assignments.md)  
- [Module Basics](2.8-module-basics.md)  