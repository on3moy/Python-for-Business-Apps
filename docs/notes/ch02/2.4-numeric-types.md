...
Lets format the floats for readability. We do this with [string formats](../ch03/3.10-string-formatting.md), which we will talk more about this later.
...
- [Objects](2.3-objects.md)  
- [String Formatting](../ch03/3.10-string-formatting.md)  