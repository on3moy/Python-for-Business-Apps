...
Every lecture deck, in one place.

!!! note "How to open these"

    Ctrl + Click to open a deck in a new tab. Once it's open, press <kbd>F</kbd>
    for fullscreen and use the arrow keys to move through it.
...
[Chapter 6 Slides](../assets/slides/ch06.html){ target="_blank" }

## Chapter 7

[Chapter 7 Slides](../assets/slides/ch07.html){ target="_blank" }

## Chapter 8

[Chapter 8 Slides](../assets/slides/ch08.html){ target="_blank" }
